...
export default function schedulerExtension(pi: ExtensionAPI) {
	...
	pi.registerTool({
		...
		promptGuidelines: [
			...
			"Do not schedule a watch whose sole purpose is waiting for pr_review findings: pr_review findings are delivered directly into agent context. Wait for that context instead. Schedule PR watches for external CI and GitHub review state after gh_safe pr_create or for user-requested existing PRs.",
